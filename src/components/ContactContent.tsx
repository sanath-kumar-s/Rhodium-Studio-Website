...
export function ContactContent() {
  ...
  return (
    <main className="relative z-10 w-full max-w-7xl px-6 md:px-20 py-[clamp(3rem,10vw,8rem)] flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-20">
      {/* Left Side — Editorial */}
